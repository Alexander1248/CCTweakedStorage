...
__bundle_register("network", function(require, _LOADED, __bundle_register, __bundle_modules)
...
_ba:addBlit(_c(1 +_aa,1),dca+aaa,ada,bda,cda)end end end end)end}daa.__index=daa;return setmetatable(daa,dc)end end;return aa["main"]()
end)
__bundle_register("basalt", function(require, _LOADED, __bundle_register, __bundle_modules)
local aa={}local ba=true;local ca=require
local da=function(ab)
for bb,cb in pairs(aa)do
if(type(cb)=="table")then for db,_c in pairs(cb)do if(db==ab)then
